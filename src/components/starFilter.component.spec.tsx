...
describe('StarFilter', () => {
    it('should display the input correctly', async () => {
      const {container} = render(<StarFilter availableRatings={ratings} handleChange={handleChange}/>);
    ...
    it('Check state change and parent function called', () => {
      const {getByTestId} = render(<StarFilter availableRatings={ratings} handleChange={handleChange}/>);
